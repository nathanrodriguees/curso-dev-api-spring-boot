package br.edu.senaisp.Aula27_11_04_25.config;
...
import br.edu.senaisp.Aula27_11_04_25.Aula27110425Application;

@Configuration
public class Internacionalizacao {

	Logger log = LoggerFactory.getLogger(Aula27110425Application.class);
