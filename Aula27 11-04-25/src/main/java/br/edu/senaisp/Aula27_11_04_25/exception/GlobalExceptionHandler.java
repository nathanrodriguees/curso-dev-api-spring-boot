package br.edu.senaisp.Aula27_11_04_25.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> recursoNotFound(RecursoNotFound e, HttpServletRequest request) {
		...
		MensagemErro msg = new MensagemErro(LocalDateTime.now(), msgLang, request.getContextPath());
	...
	public ResponseEntity<?> geralNoResourceFoundException(NoResourceFoundException e, WebRequest request) {
