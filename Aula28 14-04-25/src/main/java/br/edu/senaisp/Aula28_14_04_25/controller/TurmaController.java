...
import br.edu.senaisp.Aula28_14_04_25.service.TurmaService;
...
public class TurmaController {
	...
	public String testeJPA() {
		List<Turma> t = repoTurma.findByNome("Java");

//		long qtd = repoTurma.count();

//		long qtd = repoTurma.countByNome("Java");

		List<Turma> lista = repoTurma.findByNomeNotContains("Java");
